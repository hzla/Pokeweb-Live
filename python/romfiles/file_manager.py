...
# EXTRACTING USAGE: python file_manager.py -extract path_to_rom path_to_narc file_index 
...
subfile_name = sys.argv[4]

is subfile_name == "none":
	subfile_name = False
