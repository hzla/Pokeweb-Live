...
Action.rand_teams
```
Randomize every team on the rom based on settings in the pokeweb/randomizer folder. 
...
Action.rand_teams
```
Randomize every encounter on the rom based on settings in the pokeweb/randomizer folder. 
